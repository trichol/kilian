                                  ...
                                  Padding(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => FFButtonWidget(
                                        onPressed: ((functions.myCheckLengthString(_model.nameTextController.text, 2) == false) ||
                                            ...
                                            : () async {
                                                ...
                                                if (_model.listAlreadyReccorded
                                                        ?.length
                                                        .toString() ==
                                                    '0') {
                                                  // info notification
