...
import 'generation_cessation_contract_widget.dart'
    show GenerationCessationContractWidget;
import 'package:collection/collection.dart';
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class GenerationCessationContractModel
    extends FlutterFlowModel<GenerationCessationContractWidget> {
  ...
  // Stores action output result for [Backend Call - Create Document] action in BtnGenerationContratCessation widget.
  ContratsRecord? contratDataDoc;
  // Stores action output result for [Firestore Query - Query a collection] action in BtnGenerationContratCessation widget.
  UsersRecord? currentUserContractantDoc;
  // Stores action output result for [Custom Action - buildContratPDF] action in BtnGenerationContratCessation widget.
  String? resultBuidPDF;
  // Stores action output result for [Custom Action - getDownloadUrl] action in BtnGenerationContratCessation widget.
