...
import 'generation_cessation_contract_model.dart';
export 'generation_cessation_contract_model.dart';

class GenerationCessationContractWidget extends StatefulWidget {
  const GenerationCessationContractWidget({super.key});

  @override
  State<GenerationCessationContractWidget> createState() =>
      _GenerationCessationContractWidgetState();
}

class _GenerationCessationContractWidgetState
    extends State<GenerationCessationContractWidget> {
  late GenerationCessationContractModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GenerationCessationContractModel());
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  if (_model
                                          .currentPhoneTxtTextController.text !=
                                      currentPhoneNumber) {
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                if ((_model.articleTextController.text !=
                                  ...
                                  // create objetContrat
                                  _model
                                      .addToListObjetContrat(ObjetContratStruct(
                                  ...
                                  while (FFAppState().iLoop <
                                      _model
                                          .listPhoneContractantValide.length) {
                                    // find contractant
                                    ...
                                    _model.addToListContractants(
                                      ...
                                      prenom: _model
                                          .currentUserContractantDoc?.nickname,
                                      phoneNumber: _model
                                          .listPhoneContractantValide
                                      ...
                                      status: FFAppConstants.listeStatus
                                          .elementAtOrNull(0),
                                      uid:
                                          _model.currentUserContractantDoc?.uid,
                                      genre: _model
                                          .currentUserContractantDoc?.genre,
                                      signature: _model
                                          .currentUserContractantDoc?.signature,
                                      email: _model
                                  ...
                                  FFAppState().updateContratDataAppStateStruct(
                                    (e) => e
                                      ...
                                      ..type = FFAppConstants.listeLabelContrat
                                      ...
                                      ..status = FFAppConstants.listeStatus
                                          .elementAtOrNull(
                                              FFAppState().indiceStatusAppState)
                                      ..contractantsData =
                                      ...
                                      ..horaireRendezVous =
                                          functions.myParseDateFromString(_model
                                              .horaireRendezVousTextController
                                              .text)
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: Text(_model.resultBuidPDF!),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),
