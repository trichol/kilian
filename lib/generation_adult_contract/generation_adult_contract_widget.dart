                            ...
                            Expanded(
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  focusNode: _model.horaireRendezVousFocusNode,
                                  autofocus: false,
                                        ...
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                                            child:
                                                const Text('Choisir un autre numéro'),
                                          ),
                                        ],
                                      );
                                    },
                            ...
                            onPressed: () async {
                              ...
                              if (_model.checkboxGroupValues?.length == 0) {
                                ...
                                var contratsRecordReference = ContratsRecord
                                    .collection
                                    .doc(FFAppState().contratDataAppState.uid);
                                ...
                                while (FFAppState().iLoop <
                                  ...
                                  if (!(_model.currentUserContractantDoc
                                    ...
                                    FFAppState()
                                      ...
                                      (e) =>
                                          e..allContractantsRegistered = false,
                                    );
                                  }
                                  // CREATION CONTRACTANT
                                  _model.addToListContractants(
                                      ContractantDataStruct(
                                    nom: _model.currentUserContractantDoc?.name,
                                    prenom: _model
                                    ...
                                    status: FFAppConstants.listeStatus
                                        .elementAtOrNull(0),
                                    uid: _model.currentUserContractantDoc?.uid,
                                    genre:
                                        _model.currentUserContractantDoc?.genre,
                                    signature: _model
                                ...
                                if (_model.resultBuidPDF == null ||
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title:
                                            const Text('Création contrat impossible'),
