                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed: ((_model.emailAddressTextController.text ==
                                                                                  '') ||
                                                                          (functions.myCheckLengthString(_model.passwordTextController.text, 6) ==
                                                                              false))
                                                                      ? null
                                                                      : () async {
                                                                          // LOGIN
                                                                          _model.isAuthLogged =
                                                                              await actions.myLoginWithErrorHandling(
                                                                          ...
                                                                          if (_model
                                                                            ...
                                                                            if (valueOrDefault<bool>(currentUserDocument?.isCompleteRegistration, false) ==
                                                                              ...
                                                                              // Geolocation
                                                                              _model.userCurrentLocation = await GeoJSLocationCall.call();
                                                                              ...
                                                                              await currentUserReference!.update(createUsersRecordData(
                                                                                ...
                                                                                location: updateLocationDataStruct(
                                                                                  LocationDataStruct.maybeFromMap((_model.userCurrentLocation?.jsonBody ?? '')),
                                                                                  clearUnsetFields: false,
                                                                                ),
                                                                              ));
                                                                              // genearate and save firebase token
                                                                              _model.isTokenGenerateAndSave = await actions.generateAndSaveDeviceToken(
                                                                                currentUserUid,
                                                                              );
                                                                              if (_model.isTokenGenerateAndSave == true) {
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            // generate and save firebase token
                                                                          ...
                                                                          : Padding(
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  if (valueOrDefault<bool>(currentUserDocument?.isCompleteRegistration, false) == true) {
                                                                                    context.pushNamedAuth('dashboard', context.mounted);
                                                                                  } else {
                                                              ...
                                                              Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (_model.isAccountCreatedGoogle ==
                                                                            null ||
                                                                        _model.isAccountCreatedGoogle ==
                                                                            '') {
                                                                      await authManager
                                                                  ...
                                                                  : Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          _model.isAccountAppleCreated =
                                                                              await actions.createAccountWithErrorHandling(
                                                                            _model.emailAddressCreateTextController.text,
                                                                            _model.passwordConfirmTextController.text,
                                                                          );
                                                                          if (_model.isAccountAppleCreated == null ||
                                                                              _model.isAccountAppleCreated == '') {
                                                                            if (valueOrDefault<bool>(currentUserDocument?.isCompleteRegistration, false) ==
                                                                                true) {
                                                                              context.pushNamedAuth('dashboard', context.mounted);
